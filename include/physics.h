...
glm::vec3 voxel_to_world(float x, float y, float z) {
...
extern const float smoothing_length = 20.0f * particle_radius;
extern const float particle_viscosity = 250.0f;
extern const glm::vec3 gravity_force = glm::vec3(0.0f, -10.0f, 0.0f);
extern const float particle_stiffness = 200.0f; // aka K
