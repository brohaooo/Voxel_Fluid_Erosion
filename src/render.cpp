...
void set_up_cube_base_instance_rendering(unsigned int cube_VBO[2], unsigned int cube_VAO[2], unsigned int& voxel_instance_VBO) {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(GLfloat) * 6 * voxel_x_num * voxel_y_num * voxel_z_num/*not more than this value*/, NULL, GL_DYNAMIC_DRAW);// dynamic draw, update every frame
